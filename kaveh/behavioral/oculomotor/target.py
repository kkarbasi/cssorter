...
class target:
    ...
    def _find_target_jumps_horizontal(self):
        ...
        target_jump_indices = scipy.signal.find_peaks(ht_diff, prominence=0.5)[0]
    ...
    def _find_target_jumps_vertical(self):
        ...
        target_jump_indices = scipy.signal.find_peaks(vt_diff, prominence=0.5)[0]
    ...
    def _find_target_jumps_2d(self):
        ...
        target_jump_indices = scipy.signal.find_peaks(pos_diff, prominence=0.5)[0]
